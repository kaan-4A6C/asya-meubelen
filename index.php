    ...
    <body>
        ...
        <div class="s-swiper js__swiper-one-item">
            ...
            <a href="#js__scroll-to-section" class="s-scroll-to-section-v1--bc g-margin-b-15--xs">
                ...
                <p class="text-uppercase g-color--white g-letter-spacing--3 g-margin-b-0--xs">Bekijk nu!</p>
            </a>
        </div>
        <!--========== END SWIPER SLIDER ==========-->
        ...
        <!--========== PAGE CONTENT ==========-->
        <!-- Features -->
        <div id="js__scroll-to-section" class="container g-padding-y-80--xs g-padding-y-85--sm">
                   <div class="g-text-center--xs g-margin-b-100--xs">
                       <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2 g-margin-b-25--xs">Welkom op Asya meubelen!</p>
                   ...
                   <div class="row g-margin-b-60--xs g-margin-b-70--md">
                       <div class="col-sm-4 g-margin-b-60--xs g-margin-b-0--md">
                           <div class="clearfix">
                               ...
                               <div class="g-media__body g-padding-x-20--xs">
                                   <h3 class="g-font-size-18--xs">Snelle leveringen</h3>
                       ...
                       <div class="col-sm-4 g-margin-b-60--xs g-margin-b-0--md">
                           <div class="clearfix">
                               ...
                               <div class="g-media__body g-padding-x-20--xs">
                                   <h3 class="g-font-size-18--xs">Volledig op maat</h3>
                                   <p class="g-margin-b-0--xs">This is where we sit down, grab a cup of coffee and dial in the details.</p>
                               </div>
                           </div>
                       </div>
                       <div class="col-sm-4">
                           <div class="clearfix">
                               ...
                               <div class="g-media__body g-padding-x-20--xs">
                                   <h3 class="g-font-size-18--xs">AAA+ Kwaliteit</h3>
                                   <p class="g-margin-b-0--xs">This is where we sit down, grab a cup of coffee and dial in the details.</p>
                               </div>
                           </div>
                       </div>
        ...
        <!-- Parallax -->
        <div class="js__parallax-window" style="background: url(img/custom.jpg) 50% 0 no-repeat fixed; background-size: cover;">
            <div class="container g-text-center--xs g-padding-y-80--xs g-padding-y-125--sm">
                <div class="g-margin-b-80--xs">
                    <h2 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md g-color--white">Op maat gemaakte meubelen</h2>
                </div>
                <a href="#" class="text-uppercase s-btn s-btn--md s-btn--white-brd g-radius--50">Lees meer!</a>
            </div>
        </div>
        <!-- End Parallax -->
        ...
        <div class="g-promo-section">
            <div class="container g-padding-y-80--xs g-padding-y-125--sm">
                <div class="row">
                    <div class="col-md-4 g-margin-t-15--xs g-margin-b-60--xs g-margin-b-0--lg">
                        <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2 g-margin-b-25--xs"><hr></p>
                        <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".1s">
                            <h2 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md">Over</h2>
                        </div>
                        <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".3s">
                            <h2 class="g-font-size-40--xs g-font-size-50--sm g-font-size-40--md">Asya Meubelen</h2>
                        </div>
                    </div>
            ...
            <div class="col-sm-3 g-promo-section__img-right--lg g-bg-position--center g-height-100-percent--md js__fullwidth-img">
                <img class="img-responsive" src="img/side-img.jpg" alt="Image">
            </div>
        </div>
        <!-- End Culture -->
        <!-- News -->
        <div class="container g-padding-y-80--xs g-padding-y-80--sm">
            <div class="g-text-center--xs g-margin-b-80--xs">
                <h2 class="g-font-size-32--xs g-font-size-36--md">Onze bankenstellen</h2>
            </div>
            <div class="row">

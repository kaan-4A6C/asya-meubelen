...
<html lang="en" class="no-js">
    <head>
        ...
        <title>Asya Meubelen | Kaya</title>
    ...
    <body>
        ...
        <!--========== PROMO BLOCK ==========-->
        <div class="g-fullheight--xs js__parallax-window" style="background: url(img/sultan.jpeg) 50% 0 no-repeat fixed; background-size: cover; background-position: center;">
            <div class="g-container--md g-ver-center--xs g-text-center--xs">
                <div class="g-margin-b-70--xs">
                    <h1 class="g-font-size-55--sm g-font-size-70--lg g-font-family--playfair g-color--white g-margin-b-20--xs g-margin-b-40--sm">Sultan</h1>
                </div>
            </div>
            <a href="#js__scroll-to-section" class="s-scroll-to-section-v1--bc g-margin-b-15--xs">
                <span class="g-font-size-18--xs g-color--white ti-angle-double-down"></span>
                <p class="text-uppercase g-font-family--playfair g-color--white g-letter-spacing--3 g-margin-b-0--xs">Lees meer!</p>
            </a>
        </div>
        <!--========== END PROMO BLOCK ==========-->
